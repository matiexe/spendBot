...
# ============= CONFIGURACIÓN DE IA (Claude API) =============
CLAUDE_API_KEY = os.getenv('CLAUDE_API_KEY', '')
CLAUDE_MODEL = 'claude-3-5-sonnet-20241022'  # Modelo más eficiente y económico
...
def validar_config():
    ...
    if not CLAUDE_API_KEY:
        raise ValueError(
            "❌ CLAUDE_API_KEY no está definido. "
            "Agrega tu API key de Claude en el archivo .env"
        )
    return True
